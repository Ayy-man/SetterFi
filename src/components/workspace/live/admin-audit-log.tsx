...
const EVENT_PHRASES: Record<AuditActionKey, EventPhrase> = {
  ...
  "followup_copy.approved": { verb: "approved", object: "follow-up copy" },
  "followup_copy.draft.saved": { verb: "saved", object: "a follow-up copy draft" },
  "followup_copy.rejected": { verb: "rejected", object: "follow-up copy" },
  "followup_copy.submitted": { verb: "submitted", object: "follow-up copy" },
